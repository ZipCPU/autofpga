...
#define	R_HDMI_INCLK      	0x0080000c	// 0080000c, wbregs names: HCLKIN
// HDMI-IN Clock Counter (measures clock speed)
#define	R_HDMI_INCLK      	0x0080000c	// 0080000c, wbregs names: HCLKIN
// HDMI-OUT Clock Counter (measures clock speed)
#define	R_HDMI_OUTCLK     	0x00800010	// 00800010, wbregs names: HCLKOUT
// HDMI-OUT Clock Counter (measures clock speed)
#define	R_HDMI_OUTCLK     	0x00800010	// 00800010, wbregs names: HCLKOUT
...
#define	R_PWRCOUNT        	0x0080001c	// 0080001c, wbregs names: PWRCOUNT
#define	R_RTCDATE         	0x00800020	// 00800020, wbregs names: RTCDATE, DATE
#define	R_RTCDATE         	0x00800020	// 00800020, wbregs names: RTCDATE, DATE
#define	R_SPIO            	0x00800024	// 00800024, wbregs names: SPIO
#define	R_SPIO            	0x00800024	// 00800024, wbregs names: SPIO
// A register capturing subseconds, locked to GPS if present
#define	R_SUBSECONDS      	0x00800028	// 00800028, wbregs names: SUBSECONDS
// A register capturing subseconds, locked to GPS if present
#define	R_SUBSECONDS      	0x00800028	// 00800028, wbregs names: SUBSECONDS
// SYSCLK Clock Counter (measures clock speed)
#define	R_SYSCLK          	0x0080002c	// 0080002c, wbregs names: SYSCLK
// SYSCLK Clock Counter (measures clock speed)
#define	R_SYSCLK          	0x0080002c	// 0080002c, wbregs names: SYSCLK
#define	R_VERSION         	0x00800030	// 00800030, wbregs names: VERSION
#define	R_VERSION         	0x00800030	// 00800030, wbregs names: VERSION
...
#define	R_OLED_DATA       	0x00b0004c	// 00b00040, wbregs names: ODATA
// RTC clock registers
#define	R_CLOCK           	0x00b00060	// 00b00060, wbregs names: CLOCK
...
#define	ISPIF_EN	0x80100010
#define	ISPIF_DIS	0x00100010
#define	ISPIF_CLR	0x00000010
