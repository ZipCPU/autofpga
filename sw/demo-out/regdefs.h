...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	./autofpga ./autofpga clock.txt bkram.txt flash.txt zipmaster.txt wbubus.txt dlyarbiter.txt gps.txt icape.txt mdio.txt spio.txt wboledbw.txt rtcdate.txt hdmi.txt clkcounter.txt gpio.txt pwrcount.txt wbpmic.txt version.txt buserr.txt pic.txt rtcgps.txt wbmouse.txt
//
...
#define	R_EDID_SCOPC   	0x00000500	// 00000500, wbregs names: ESCOPC, ESCOPE
#define	R_EDID_SCOPD   	0x00000504	// 00000500, wbregs names: ESCOPD
// GPS clock tracker, control loop settings registers
#define	R_GPS_ALPHA    	0x00000510	// 00000510, wbregs names: ALPHA
#define	R_GPS_BETA     	0x00000514	// 00000510, wbregs names: BETA
#define	R_GPS_GAMMA    	0x00000518	// 00000510, wbregs names: GAMMA
#define	R_GPS_STEP     	0x0000051c	// 00000510, wbregs names: STEP
#define	R_MOUSE_STAT   	0x00000520	// 00000520, wbregs names: MSTAT
#define	R_MOUSE_RAW    	0x00000524	// 00000520, wbregs names: MRAW
#define	R_SCRN_MOUSE   	0x00000528	// 00000520, wbregs names: MOUSE
#define	R_SCRN_SIZE    	0x0000052c	// 00000520, wbregs names: MSIZ
#define	R_OLED_CMD     	0x00000530	// 00000530, wbregs names: OLED
#define	R_OLED_CDATA   	0x00000534	// 00000530, wbregs names: OLEDCA
#define	R_OLED_CDATB   	0x00000538	// 00000530, wbregs names: OLEDCB
#define	R_OLED_DATA    	0x0000053c	// 00000530, wbregs names: ODATA
// RTC clock registers
#define	R_CLOCK        	0x00000540	// 00000540, wbregs names: CLOCK, TIMER
#define	R_TIMER        	0x00000544	// 00000540, wbregs names: TIMER
#define	R_STOPWATCH    	0x00000548	// 00000540, wbregs names: STOPWATCH
#define	R_CKALARM      	0x0000054c	// 00000540, wbregs names: ALARM, CKALARM
// GPS clock test bench registers, for measuring the clock trackers performance
#define	R_GPSTB_FREQ   	0x00000560	// 00000560, wbregs names: GPSFREQ
#define	R_GPSTB_JUMP   	0x00000564	// 00000560, wbregs names: GPSJUMP
#define	R_GPSTB_ERRHI  	0x00000568	// 00000560, wbregs names: ERRHI
#define	R_GPSTB_ERRLO  	0x0000056c	// 00000560, wbregs names: ERRLO
#define	R_GPSTB_COUNTHI	0x00000570	// 00000560, wbregs names: CNTHI
#define	R_GPSTB_COUNTLO	0x00000574	// 00000560, wbregs names: CNTLO
#define	R_GPSTB_STEPHI 	0x00000578	// 00000560, wbregs names: STEPHI
#define	R_GPSTB_STEPLO 	0x0000057c	// 00000560, wbregs names: STEPLO
// HDMI EDID for the input HDMI port
#define	R_EDID_IN      	0x00000580	// 00000580, wbregs names: EDIN


// WB-Microphone registers
#define	R_MIC_DATA     	0x00000600	// 00000600, wbregs names: MICD
#define	R_MIC_CTRL     	0x00000604	// 00000600, wbregs names: MICC
// FLASH erase/program configuration registers
#define	R_QSPI_EREG    	0x00000610	// 00000610, wbregs names: QSPIE
#define	R_QSPI_CREG    	0x00000614	// 00000610, wbregs names: QSPIC
#define	R_QSPI_SREG    	0x00000618	// 00000610, wbregs names: QSPIS
#define	R_QSPI_IDREG   	0x0000061c	// 00000610, wbregs names: QSPII
// GPS UART registers, similar to WBUART
#define	R_GPSU_SETUP   	0x00000620	// 00000620, wbregs names: GPSSETUP
#define	R_GPSU_FIFO    	0x00000624	// 00000620, wbregs names: GPSFIFO
#define	R_GPSU_UARTRX  	0x00000628	// 00000620, wbregs names: GPSRX
#define	R_GPSU_UARTTX  	0x0000062c	// 00000620, wbregs names: GPSTX
