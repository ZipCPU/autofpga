...
static volatile unsigned *const _buspic = &((unsigned *)0x00000404);
...
static volatile WBMOUSE *const _mouse = &((WBMOUSE *)0x00000520);

#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = &((unsigned *)0x00000400);

#define	_BOARD_HAS_OLED
static volatile OLEDRGB *const _oled = &((OLEDRGB *)0x00000530);

#define	_BOARD_HAS_GPIO
static volatile unsigned *const _gpio = &((unsigned *)0x00000410);
