...
static volatile OLEDRGB *const _oledbw = &((OLEDRGB *)1328);
...
static volatile @$THIS.IOTYPE *const _gpsu = &((@$THIS.IOTYPE *)1568);
...
static volatile WBMIC *const _wbmic = &((WBUART *)1536);
...
#define	SYSPIC_MOUSE	SYSPIC(8)
#define	SYSPIC_OLED	SYSPIC(9)
// PIC: altpic
