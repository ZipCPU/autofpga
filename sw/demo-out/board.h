...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	./autofpga ./autofpga bkram.txt enet.txt flash.txt gps.txt icape.txt mdio.txt wbuart.txt sdspi.txt wbmouse.txt wboled.txt clkcounter.txt gpio.txt pwrcount.txt version.txt buserr.txt zipmaster.txt pic.txt rtcgps.txt clock.txt hdmi.txt
//
...
static volatile unsigned *const _gpio = &((unsigned *)1040);

#define	_BOARD_HAS_WBMOUSE
static volatile WBMOUSE *const _mouse = &((WBMOUSE *)1312);

#define	_BOARD_HAS_WBUART
static volatile WBUART *const _uart = &((WBUART *)1376);

#define	_BOARD_HAS_OLED
static volatile OLEDRGB *const _oled = &((OLEDRGB *)1328);
...
static volatile *const _netp = &((ENETPACKET *)1440);
