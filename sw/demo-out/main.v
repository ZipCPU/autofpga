...
`include "builddate.v"
	...
	assign	   scop_edid_sel = (dio_sel)&&(dio_skip[ 3: 0] ==  4'b0000_);
	assign	         gck_sel = (dio_sel)&&(dio_skip[ 3: 0] ==  4'b0001_);
	...
	assign	         gtb_sel = (dio_sel)&&(dio_skip[ 3: 1] ==  3'b011);
	assign	        edin_sel = (dio_sel)&&(dio_skip[ 3: 3] ==  1'b1);
	wire	[7:0]	wb_skip; // bits 011007b0, sbaw=23
	assign	wb_skip = {
			wb_addr[22],
			wb_addr[18],
			wb_addr[ 8: 5],
	...
	assign	        pmic_sel = ( wb_skip[ 7: 0] ==  8'b0011_0000_);
	assign	       flctl_sel = ( wb_skip[ 7: 0] ==  8'b0011_0001_);
	assign	        gpsu_sel = ( wb_skip[ 7: 0] ==  8'b0011_0010_);
	assign	         cfg_sel = ( wb_skip[ 7: 2] ==  6'b0011_01);
	assign	        mdio_sel = ( wb_skip[ 7: 2] ==  6'b0011_10);
	assign	         mem_sel = ( wb_skip[ 7: 6] ==  2'b01);
	assign	       flash_sel = ( wb_skip[ 7: 7] ==  1'b1);
	assign	         dio_sel = ( wb_skip[ 7: 3] ==  5'b0010_1);
	assign	         sio_sel = ( wb_skip[ 7: 2] ==  6'b0010_00);
...
`endif	// CONSOLE_ACCESS
	...
	always @(posedge i_clk)
	casez({ scop_edid_ack, gck_ack, mous_ack, oled_ack, rtc_ack, gtb_ack, edin_ack })
		 7'b1??????: dio_data <= scop_edid_data;
		 7'b01?????: dio_data <= gck_data;
		 7'b001????: dio_data <= mous_data;
		 7'b0001???: dio_data <= oled_data;
		 7'b00001??: dio_data <= rtc_data;
		 7'b000001?: dio_data <= gtb_data;
		 7'b0000001: dio_data <= edin_data;
