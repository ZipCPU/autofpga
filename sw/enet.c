...
//
// Purpose:	Older description of an ethernet controller.  Doesn't work with
//		the (newer) file format, but yet demonstrates some of how that
//	newer format might work.
//
